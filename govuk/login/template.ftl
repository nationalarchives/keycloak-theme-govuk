...
<head>
    ...
    <link rel="shortcut icon" href="${url.resourcesPath}/vendor/tna_resources/favicon.ico?0.22.1" type="image/x-icon" />
    <link rel="mask-icon" href="${url.resourcesPath}/vendor/tna_resources/tna-horizontal-white-logo.svg?0.22.1" color="#0b0c0c">
    ...
    <header role="banner" id="global-header" class="${properties.kcHeaderClass!} with-proposition">
      <div class="header-wrapper">
        <div class="header-global">
            <a href="/" class="govuk-header__tna-logo">
              <img src="${url.resourcesPath}/vendor/tna_resources/tna-horizontal-white-logo.svg?0.22.1" width="220px" alt=""> 
            </a>
        </div>
